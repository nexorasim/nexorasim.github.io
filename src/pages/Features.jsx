...
import { Shield24Regular, Globe24Regular, CloudSync24Regular, Server24Regular } from '@fluentui/react-icons'
...
const Features = () => {
  ...
  return (
    <div className="features-page">
      <section className="hero-section parallax-section" ref={heroRef}>
        <div className="section-content">
          <div className="hero-content">
            ...
            <h1 className="hero-title">Interactive 3D Feature Grid</h1>
            <p className="hero-subtitle">
              Comprehensive eSIM platform capabilities with real-time analytics, 
              enterprise security, and global reach across ASEAN networks
            </p>
      ...
      <section className="features-grid-section parallax-section" ref={featuresRef}>
        <div className="section-content">
                ...
                <CardPreview>
                  ...
                  <div className="feature-capabilities">
                    {feature.capabilities.map((capability, capIndex) => (
                      <Badge key={capIndex} appearance="outline" className="capability-badge">
                        {capability}
                      </Badge>
                    ))}
                  </div>
      ...
      <section className="technical-specs-section parallax-section">
        <div className="section-content">
          <h2 className="section-title">Technical Specifications</h2>
          <div className="specs-grid">
            {technicalSpecs.map((category, index) => (
              <Card key={index} className="specs-card glass-card">
                <CardHeader>
                  <h3 className="specs-category">{category.category}</h3>
                </CardHeader>
                <CardPreview>
                  <div className="specs-list">
                    {category.specs.map((spec, specIndex) => (
                      <div key={specIndex} className="spec-item">
                        <div className="spec-metric">{spec.metric}</div>
      ...
      <section className="cta-section parallax-section">
        <div className="section-content">
          <div className="cta-content glass-morphism">
            <h2>Ready to Experience Premium eSIM Features?</h2>
            <p>Discover how NexoraSIM transforms eSIM management with enterprise-grade capabilities</p>
            <div className="cta-actions">
              <Button appearance="primary" size="large" as={Link} to="/architecture">
                View Architecture
              </Button>
